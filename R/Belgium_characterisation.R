# Belgium characterisation

# Reads and cleans the patient characterisation information from IQVIA LPD
# Belgium

# Note that the Belgium data is not provided publicly because it contains many
...
# Inputs -----
# input file
file_path <- "./Data/Importable data/CSAW_Characterization_LPDBelgium.xls"

# output folder
output_path <- "./Output/"

output_file_name <- "Belgium_patient_characteristics.csv"
...
results <- lapply(sheets, function (x){
